...
$functions = array(
    'tool_tallerbehat_delete_entry' => array(
        'classname' => 'tool_tallerbehat_external',
        'methodname' => 'delete_entry',
        'description' => 'Deletes an entry',
        'type' => 'write',
        'capabilities' => 'tool/tallerbehat:edit',
        'ajax' => true,
    ),
    'tool_tallerbehat_entries_list' => array(
        'classname' => 'tool_tallerbehat_external',
        'methodname' => 'entries_list',
        'description' => 'Returns list of entries',
        'type' => 'read',
        'capabilities' => 'tool/tallerbehat:view',
        'ajax' => true,
    ),
);
